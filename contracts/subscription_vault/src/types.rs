...
pub enum RecoveryReason {
    ...
    SystemCorrection = 3,
    /// Funds sent accidentally to the contract address.
...
/// Event emitted when a protocol fee is charged on an interval billing.
#[contracttype]
#[derive(Clone, Debug)]
...
/// Event emitted when the protocol fee basis points are configured by admin.
#[contracttype]
#[derive(Clone, Debug)]
